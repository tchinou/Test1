package JsoupHtmlParsing;
	 ...
	 * * files and extract elements, manipulate data, change style using DOM, CSS and * JQuery like method. * 
	 * * @author Javin Paul */ 
	
  public class HtmlParserFirstExample {
